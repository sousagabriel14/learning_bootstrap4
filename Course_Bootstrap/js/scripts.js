...
$(document).ready(function() {
    ...
    function eachBoxes(type, boxes) {
        ...
        // Scroll para seções
        let navBtn = $('.nav-item');  //'nav-item' são os itens do menu superior principal
        ...
        //Criando evento de clique ao btn
        $(navBtn).click(function() {

            let btnId = $(this).attr('id');

            // debug para saber se  esta passando os id's certos 'console.log(btnId);' 

            // Condicionando os id's do menu para dar um scrollTo para a area desejada quando selecionado
            if (btnId == 'about-menu') {
            ...
            //Criando a animação do scroll atrelado ao evento de click
